...
export default function DomicilePDF({ data }: DomicilePDFProps) {
  ...
  return (
    <>
      <div className="no-print flex justify-end items-center mb-4 space-x-2">
      ...
      <Card className="printable-area" id="printable-area">
        <CardContent className="p-0">
          ...
          `}</style>
           <table className="mgn" border={0} align="center" width="90%" cellSpacing="0" cellPadding="0" style={{border: '1px solid #000000', paddingLeft: '4px', paddingRight: '4px', paddingTop: '1px', paddingBottom: '1px', fontSize: '10pt', fontFamily: 'Arial Unicode MS', backgroundImage: 'url("/background.png")', backgroundRepeat: 'no-repeat', backgroundPosition: 'center right', backgroundSize: '430px'}}>
            <tbody>
              <tr><td colSpan={6}>&nbsp;ई-डिस्ट्रिक्ट के अन्तर्गत जारी..</td></tr>
              <tr><td colSpan={6}><p align="center"><img src="/logo.jpg" width="110" height="110" alt="Logo" /></p></td></tr>
              ...
              <tr><td colSpan={6}><table border={0} style={{fontSize: '10pt'}} width="100%" cellSpacing="0" cellPadding="0"><tbody>
                <tr>
                    ...
                    <td width="25%" rowSpan={6} align="left" valign="top"><img style={{width: '96px', height: '96px', objectFit: 'cover'}} src={data.photoUrl} alt="Applicant" /></td>
                </tr>
